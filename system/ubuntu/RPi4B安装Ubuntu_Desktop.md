...
- [getiot](https://getiot.tech/rpi/how-to-install-ubuntu-desktop-on-raspberry-pi.html) - [FOSS](https://itsfoss.com/install-ubuntu-desktop-raspberry-pi/) - [51cto](https://os.51cto.com/article/683524.html)  
...
- Ubuntu Server 版要比Desktop版节省很多资源。  
...
- ubuntu-21.10-preinstalled-desktop-arm64+raspi.img.xz 镜像大约1.9G。
在 macOS 下双击，将调起 Archive Utility 软件解压出9.41G的原始镜像。
- ubuntu-21.10-preinstalled-server-arm64+raspi.img.xz 镜像大约923M，在 macOS 下双击，将调起 Archive Utility 软件解压出4.08G的原始镜像。
...
```Shell
$ cd ~/Downloads
#sudo dd bs=1m if=ubuntu-21.10-preinstalled-desktop-arm64+raspi.img of=/dev/rdisk2 conv=sync
$ sudo dd bs=1m if=ubuntu-21.10-preinstalled-desktop-arm64+raspi.img of=/dev/rdisk2; sync
```
...
```Shell
~/Downloads » sudo dd bs=1m if=ubuntu-21.10-preinstalled-desktop-arm64+raspi.img of=/dev/rdisk2; sync
Password:
# 按下 ^T 查看进度
load: 2.74  cmd: dd 14903 uninterruptible 0.00u 1.21s
1998+0 records in
1997+0 records out
...
[清华大学 Ubuntu 镜像使用帮助](https://mirrors.tuna.tsinghua.edu.cn/help/ubuntu/) - [ubuntu-ports 镜像](https://mirrors.tuna.tsinghua.edu.cn/ubuntu-ports/)

[中科大 USTC](http://mirrors.ustc.edu.cn/)

- [Ubuntu 源使用帮助](http://mirrors.ustc.edu.cn/help/ubuntu.html)  
- [Ubuntu Ports 源使用帮助](http://mirrors.ustc.edu.cn/help/ubuntu-ports.html)  
